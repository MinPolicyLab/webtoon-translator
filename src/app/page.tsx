  ...
  return (
    <div className={styles.page}>
      ...
      <p className={styles.subhead}>
        ...
        배경색을 읽어 원문을 지우고 번역문을 다시 그려 넣습니다. 한 페이지에 여러 언어가 섞여
        있어도 다국어 자동 인식으로 함께 처리합니다. 파일 하나만 처리하거나, 폴더를 통째로 골라
        그 안의 파일 전체를 한 번에 처리할 수 있습니다. 다른 웹사이트의 화면을 읽어오는 기능은
        아니며, 사용자가 직접 고른 파일·폴더만 처리합니다.
      </p>
